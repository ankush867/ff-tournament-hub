...
import { q as ProtocolError, T as TimeoutWaitingForResponseErrorCode, s as utf8ToBytes, t as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, v as lookupResultToBuffer, w as RequestStatusResponseStatus, x as UnknownError, y as RequestStatusDoneNoReplyErrorCode, z as RejectError, A as CertifiedRejectErrorCode, D as UNREACHABLE_ERROR, I as InputError, F as InvalidReadStateRequestErrorCode, G as ReadRequestType, H as Principal, J as IDL, K as MissingCanisterIdErrorCode, N as HttpAgent, O as encode, Q as QueryResponseStatus, V as UncertifiedRejectErrorCode, W as isV3ResponseBody, Y as isV2ResponseBody, _ as UncertifiedRejectUpdateErrorCode, $ as UnexpectedErrorCode, a0 as decode, a1 as Subscribable, a2 as pendingThenable, a3 as resolveEnabled, a4 as shallowEqualObjects, a5 as resolveStaleTime, a6 as noop, a7 as environmentManager, a8 as isValidTimeout, a9 as timeUntilStale, aa as timeoutManager, ab as focusManager, ac as fetchState, ad as replaceData, ae as notifyManager, r as reactExports, af as shouldThrowError, d as useQueryClient, ag as useInternetIdentity, ah as createActorWithConfig, ai as Record, aj as Opt, ak as Variant, al as Vec, am as Service, an as Func, ao as Text, ap as Nat8, aq as Nat, ar as Bool, as as Null, at as Int, au as Principal$1 } from "./index-DJ3jSp6d.js";
...
const SubmitPaymentInput = Record({
  "matchId": MatchId,
  "utrNumber": Text,
  "screenshot": ExternalBlob
});
const UpdateMatchInput = Record({
  "scheduledTime": Opt(Timestamp),
  "name": Opt(Text),
...
Service({
  ...
  "approvePayment": Func([PaymentId], [], []),
  "assignCallerUserRole": Func([Principal$1, UserRole], [], []),
  "closeMatch": Func([MatchId], [], []),
  "createMatch": Func([CreateMatchInput], [MatchPublic], []),
  "deleteMatch": Func([MatchId], [], []),
  "getCallerUserRole": Func([], [UserRole], ["query"]),
  "getMatch": Func([MatchId], [Opt(MatchPublic)], ["query"]),
  "getMatchPlayers": Func([MatchId], [Vec(UserId)], ["query"]),
  "getMatchResults": Func([MatchId], [Vec(Result)], ["query"]),
  "getMyPayments": Func([], [Vec(PaymentPublic)], ["query"]),
  "getMyProfile": Func([], [Opt(UserPublic)], ["query"]),
  "getRoomCredentials": Func([MatchId], [MatchCredentials], ["query"]),
  "getUserById": Func([UserId], [Opt(UserPublic)], ["query"]),
  "isCallerAdmin": Func([], [Bool], ["query"]),
  "listAllPayments": Func([], [Vec(PaymentPublic)], ["query"]),
  "listMatches": Func([], [Vec(MatchPublic)], ["query"]),
  "listPaymentsByMatch": Func(
    [MatchId],
    [Vec(PaymentPublic)],
    ["query"]
  ),
  "listUsers": Func([], [Vec(UserPublic)], ["query"]),
  "loginUser": Func([Text, Text], [Opt(UserPublic)], []),
  "register": Func([RegisterInput], [UserPublic], []),
  "rejectPayment": Func([PaymentId], [], []),
  "submitPayment": Func([SubmitPaymentInput], [PaymentPublic], []),
  "suspendUser": Func([UserId], [], []),
  "unsuspendUser": Func([UserId], [], []),
  "updateMatch": Func([MatchId, UpdateMatchInput], [MatchPublic], []),
  "updateMyProfile": Func([UpdateProfileInput], [UserPublic], []),
  "uploadResults": Func(
    [MatchId, Vec(ResultInput)],
    [Vec(Result)],
    []
  )
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const CreateMatchInput2 = IDL2.Record({
    "scheduledTime": Timestamp2,
    "name": IDL2.Text,
    "roomPassword": IDL2.Text,
    "entryFee": IDL2.Nat,
    "roomId": IDL2.Text,
    "prizePool": IDL2.Nat
  });
  ...
  const MatchPublic2 = IDL2.Record({
    "id": MatchId2,
    "status": MatchStatus2,
    "scheduledTime": Timestamp2,
    "name": IDL2.Text,
  ...
  const UserPublic2 = IDL2.Record({
    ...
    "username": IDL2.Text,
    "createdAt": Timestamp2,
    "walletBalance": IDL2.Nat,
    "ffUid": IDL2.Text
  });
  const MatchCredentials2 = IDL2.Record({
    "roomPassword": IDL2.Text,
    "roomId": IDL2.Text
  });
  ...
  const SubmitPaymentInput2 = IDL2.Record({
    "matchId": MatchId2,
    "utrNumber": IDL2.Text,
    "screenshot": ExternalBlob2
  });
  const UpdateMatchInput2 = IDL2.Record({
    "scheduledTime": IDL2.Opt(Timestamp2),
    "name": IDL2.Opt(IDL2.Text),
    "roomPassword": IDL2.Opt(IDL2.Text),
    "entryFee": IDL2.Opt(IDL2.Nat),
    "roomId": IDL2.Opt(IDL2.Text),
    "prizePool": IDL2.Opt(IDL2.Nat)
  });
  const UpdateProfileInput2 = IDL2.Record({
    "username": IDL2.Opt(IDL2.Text),
    "password": IDL2.Opt(IDL2.Text),
    "ffUid": IDL2.Opt(IDL2.Text)
  });
  const ResultInput2 = IDL2.Record({
    "username": IDL2.Text,
    "userId": UserId2,
    "rank": IDL2.Nat,
    "prize": IDL2.Nat,
  ...
  return IDL2.Service({
    ...
    "approvePayment": IDL2.Func([PaymentId2], [], []),
    "assignCallerUserRole": IDL2.Func([IDL2.Principal, UserRole2], [], []),
    "closeMatch": IDL2.Func([MatchId2], [], []),
    "createMatch": IDL2.Func([CreateMatchInput2], [MatchPublic2], []),
    "deleteMatch": IDL2.Func([MatchId2], [], []),
    "getCallerUserRole": IDL2.Func([], [UserRole2], ["query"]),
    "getMatch": IDL2.Func([MatchId2], [IDL2.Opt(MatchPublic2)], ["query"]),
    "getMatchPlayers": IDL2.Func([MatchId2], [IDL2.Vec(UserId2)], ["query"]),
    "getMatchResults": IDL2.Func([MatchId2], [IDL2.Vec(Result2)], ["query"]),
    "getMyPayments": IDL2.Func([], [IDL2.Vec(PaymentPublic2)], ["query"]),
    "getMyProfile": IDL2.Func([], [IDL2.Opt(UserPublic2)], ["query"]),
    "getRoomCredentials": IDL2.Func([MatchId2], [MatchCredentials2], ["query"]),
    "getUserById": IDL2.Func([UserId2], [IDL2.Opt(UserPublic2)], ["query"]),
    "isCallerAdmin": IDL2.Func([], [IDL2.Bool], ["query"]),
    "listAllPayments": IDL2.Func([], [IDL2.Vec(PaymentPublic2)], ["query"]),
    "listMatches": IDL2.Func([], [IDL2.Vec(MatchPublic2)], ["query"]),
    "listPaymentsByMatch": IDL2.Func(
      [MatchId2],
      [IDL2.Vec(PaymentPublic2)],
      ["query"]
    ),
    "listUsers": IDL2.Func([], [IDL2.Vec(UserPublic2)], ["query"]),
    "loginUser": IDL2.Func([IDL2.Text, IDL2.Text], [IDL2.Opt(UserPublic2)], []),
    "register": IDL2.Func([RegisterInput2], [UserPublic2], []),
    "rejectPayment": IDL2.Func([PaymentId2], [], []),
    "submitPayment": IDL2.Func([SubmitPaymentInput2], [PaymentPublic2], []),
    "suspendUser": IDL2.Func([UserId2], [], []),
    "unsuspendUser": IDL2.Func([UserId2], [], []),
    "updateMatch": IDL2.Func([MatchId2, UpdateMatchInput2], [MatchPublic2], []),
    "updateMyProfile": IDL2.Func([UpdateProfileInput2], [UserPublic2], []),
    "uploadResults": IDL2.Func(
      [MatchId2, IDL2.Vec(ResultInput2)],
      [IDL2.Vec(Result2)],
      []
    )
  });
...
class Backend {
  ...
  async listPaymentsByMatch(arg0) {
    if (this.processError) {
      try {
...
function from_candid_MatchPublic_n10(_uploadFile, _downloadFile, value) {
  return from_candid_record_n11(_uploadFile, _downloadFile, value);
}
function from_candid_MatchStatus_n12(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n13(_uploadFile, _downloadFile, value);
}
async function from_candid_PaymentPublic_n18(_uploadFile, _downloadFile, value) {
...
function from_candid_UserPublic_n24(_uploadFile, _downloadFile, value) {
  return from_candid_record_n25(_uploadFile, _downloadFile, value);
}
function from_candid_UserRole_n14(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n15(_uploadFile, _downloadFile, value);
}
function from_candid_UserStatus_n26(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n13(_uploadFile, _downloadFile, value) {
  return "closed" in value ? "closed" : "open" in value ? "open" : "completed" in value ? "completed" : value;
}
...
async function to_candid_SubmitPaymentInput_n30(_uploadFile, _downloadFile, value) {
  return await to_candid_record_n31(_uploadFile, _downloadFile, value);
}
function to_candid_UpdateMatchInput_n33(_uploadFile, _downloadFile, value) {
  return to_candid_record_n34(_uploadFile, _downloadFile, value);
}
function to_candid_UpdateProfileInput_n35(_uploadFile, _downloadFile, value) {
